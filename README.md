...
![Screenshot of compose-updater, showing a stack table with a mix of enabled/disabled containers, update statuses, and last-updated times (mocked-up demo content)](docs/screenshot.png)
